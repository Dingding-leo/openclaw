...
export const tr: TranslationMap = {
  ...
  dashboardsPage: {
    ...
    emptyDescription: "Bir konuşma açın ve buraya eklemek için Dashboard yüzüne geçin.",
  ...
  agents: {
    ...
    files: {
      ...
      addFile: "Dosya ekle…",
      createHint:
        "Bu dosya henüz mevcut değil. Kaydetmek dosyayı agent çalışma alanında oluşturacaktır.",
      content: "Content",
      words: "{count} words",
      lines: "lines",
    },
  ...
  subtitles: {
    ...
    dashboards: "Dashboard yüzünde açılan konuşmalar.",
  ...
  memoryPage: {
    ...
    engine: {
      ...
      disabledHint:
        "Bellek yuvası bu eklentiye işaret ediyor, ancak eklentinin kendisi devre dışı olduğu için bellek çalışmıyor.",
      enable: "Etkinleştirin:",
    },
    backend: {
      title: "Arka uç",
      description: "Seçilen motor için belleğin nasıl depolandığı ve alındığı.",
      rowTitle: "Alma arka ucu",
      builtin: "Yerleşik",
      qmd: "QMD",
      builtinHint: "Bellek dosyaları OpenClaw'ın kendisi tarafından dizinlenir ve aranır.",
      qmdHint: "Alma işlemi QMD'ye devredilir. Ayarları aşağıda görünür.",
    },
    addons: {
      title: "Eklentiler",
      description:
        "Bu eklentiler yuva için rekabet etmek yerine motorun üzerine katmanlanır, böylece herhangi bir kombinasyon aynı anda çalışabilir.",
      activeMemory: {
        title: "Aktif bellek",
      },
      memoryWiki: {
    ...
    dreaming: {
      ...
      schedule: {
        title: "Zamanlama",
        description: "Tam taramanın ne zaman çalıştığı ve hangi modelin bunu anlattığı.",
      },
      frequency: {
        label: "Rüya görme sıklığı",
        help: "Tam rüya görme taraması (hafif, REM, ardından derin) için cron sıklığı. Eklenti varsayılanı için boş bırakın.",
        placeholder: "0 3 * * *",
      },
      timezone: {
        label: "Saat dilimi",
      ...
      storage: {
        title: "Depolama",
        description: "Yükseltilen anıların ve rüya görme raporlarının nereye yazılacağı.",
      ...
      phases: {
        light: {
          title: "Hafif aşama",
          description: "Yeniden oynatma adaylarını hazırlayan ucuz, yakın etkinlik geçişi.",
        },
        deep: {
          title: "Derin aşama",
          description: "Kısa vadeli girdileri belleğe yükselten puanlı terfi geçişi.",
        },
        rem: {
          title: "REM aşaması",
          description: "Geriye bakış penceresi boyunca yinelenen temaları arayan örüntü geçişi.",
        },
      },
      phaseFields: {
        enabled: "Etkin",
        ...
        limit: "Sınır",
        limitHelp: "Bu aşamanın her çalışmada işlediği maksimum girdi sayısı.",
        dedupeSimilarity: "Yineleme benzerliği",
        dedupeSimilarityHelp: "İki adayın yinelenmiş olarak kabul edileceği benzerlik üst değeri.",
        minScore: "Minimum puan",
        minScoreHelp: "Bir girdinin ulaşması gereken terfi puanı.",
        minRecallCount: "Minimum hatırlama",
        minRecallCountHelp: "Bir girdinin terfi edilebilmesi için kaç kez hatırlanması gerektiği.",
        ...
        maxAgeDaysHelp: "Bu süreden daha eski kısa süreli girdileri yok say.",
        maxPromotedSnippetTokens: "Maksimum yükseltilmiş kod parçacığı jetonu",
        maxPromotedSnippetTokensHelp:
          "Her yükseltilmiş kod parçacığı için jeton bütçesi. Kaynak bilgisi bağlı kalır.",
      ...
      agentScope: {
        ...
        description:
          "Yukarıdaki ayarlar geneldir. Aşağıdaki rüya günlüğü, kısa süreli sayılar ve bakım işlemleri tek bir aracıya aittir.",
        rowTitle: "Aracı",
      },
      unsupported: {
        title: "Rüya ayarları",
        ...
        description:
          "{plugin} eklentisi bellek yuvasına sahip ve yapılandırma şemasında rüya bölümü olmadığından bu ayarlar depolanamaz. Bunları düzenlemek için Genel Bakış sekmesinde motoru değiştirin.",
      },
    },
  },
  sessionsPage: {
  ...
  labsPage: {
    ...
    toolSearch: {
      title: "Araç Arama",
      description:
        "Sınırlı bir araç dizinini görünür tutun ve geri kalanını arama arkasına erteleyin, böylece büyük MCP ve eklenti katalogları istemi kalabalıklaştırmayı bıraksın.",
    },
    localModelLean: {
      title: "Yerel modeller için yalın araçlar",
      description:
        "Daha küçük yerel modellerin zayıf ele aldığı ağır varsayılan araçları çıkarın; böylece güvenilir şekilde kullanabilecekleri daha kısa bir set kalır.",
    },
    auditMessages: {
      title: "Mesaj denetim meta verisi",
      description:
        "Doğrudan konuşmalar için içerik içermeyen meta verileri denetim defterine kaydedin. Mesaj içeriği asla saklanmaz.",
    },
  },
  aboutPage: {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      ...
      enableDetail:
        "Gecelik rüya taraması, yapılandırılmış her aracı çalışma alanında çalışarak kısa vadeli anımsamaları uzun vadeli belleğe yükseltir. Bu ayar hemen uygulanır.",
      enableConfirm: "Rüya Görmeyi Aç",
      disableTitle: "Tüm Aracılar İçin Rüya Görmeyi Kapat",
      disableDetail:
        "Gecelik rüya taraması yalnızca bu değil, yapılandırılmış her aracı için durur. Zaten yazılmış anılar kalır; yeni hiçbir şey yükseltilmez. Bu ayar hemen uygulanır.",
      disableConfirm: "Rüya Görmeyi Kapat",
      saving: "Kaydediliyor…",
      failed: "Değişiklik uygulanamadı. Bağlantınızı kontrol edip yeniden deneyin.",
    },
    status: {
