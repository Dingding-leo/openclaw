...
export const nl: TranslationMap = {
  ...
  dashboardsPage: {
    ...
    emptyDescription:
      "Open een thread en schakel naar de Dashboard-weergave om het hier toe te voegen.",
  ...
  subtitles: {
    ...
    dashboards: "Threads die op hun dashboard-weergave openen.",
  ...
  memoryPage: {
    ...
    engine: {
      ...
      changeFailed: "Kan de geheugen-engine niet wijzigen",
      disabledTitle: "Deze engine is uitgeschakeld",
      disabledHint:
        "Het geheugenslot verwijst naar deze plugin, maar de plugin zelf is uitgeschakeld, dus het geheugen draait niet.",
      enable: "Inschakelen",
    },
    backend: {
      title: "Backend",
      description: "Hoe geheugen wordt opgeslagen en opgehaald voor de geselecteerde engine.",
      rowTitle: "Ophaalbackend",
      builtin: "Ingebouwd",
      qmd: "QMD",
    ...
    addons: {
      title: "Add-ons",
      description:
        "Deze plugins worden bovenop de engine gelegd in plaats van te concurreren om het slot, dus elke combinatie kan tegelijk draaien.",
      activeMemory: {
    ...
    search: {
      intro:
        "Standaardinstellingen voor embedding en ophalen die door elke agent worden gedeeld die geen geheugenoverride heeft.",
    },
    dreaming: {
      intro:
      ...
      frequency: {
        ...
        help: "Cron-cadans voor de volledige droomcyclus (light, REM en daarna deep). Laat leeg voor de standaardwaarde van de plugin.",
        placeholder: "0 3 * * *",
      },
      timezone: {
        label: "Tijdzone",
      ...
      phases: {
        light: {
          title: "Lichte fase",
          description:
            "Goedkope controle van recente activiteit die kandidaten voor replay klaarzet.",
        },
        deep: {
          title: "Diepe fase",
          description:
            "Gescoorde promotieronde die kortetermijnvermeldingen naar het geheugen laat doorstromen.",
        },
        rem: {
          title: "REM-fase",
          description:
            "Patrooncontrole die zoekt naar terugkerende thema's binnen het terugkijkvenster.",
        },
      },
      phaseFields: {
        enabled: "Ingeschakeld",
        ...
        lookbackDaysHelp:
          "Hoe ver deze fase terugleest. Laat leeg voor de standaardwaarde van de plug-in.",
        limit: "Limiet",
        limitHelp: "Maximumaantal vermeldingen dat deze fase per run verwerkt.",
        ...
        minRecallCount: "Minimumaantal recalls",
        minRecallCountHelp:
          "Hoe vaak een vermelding opgehaald moet zijn voordat deze kan worden gepromoot.",
        minUniqueQueries: "Minimumaantal unieke query's",
        minUniqueQueriesHelp:
          "Hoeveel verschillende query's de vermelding naar boven moeten hebben gehaald.",
        recencyHalfLifeDays: "Recentheidshalfwaardetijd (dagen)",
        ...
        maxPromotedSnippetTokens: "Max. gepromote snippet-tokens",
        maxPromotedSnippetTokensHelp:
          "Tokenbudget voor elk gepromoot snippet. Herkomst blijft gekoppeld.",
      ...
      unsupported: {
        ...
        description:
          "De {plugin}-plugin bezit het geheugenslot en het configuratieschema ervan heeft geen droomsectie, dus deze instellingen kunnen niet worden opgeslagen. Wijzig de engine op het tabblad Overzicht om ze te bewerken.",
      },
    },
  },
  sessionsPage: {
  ...
  labsPage: {
    ...
    toolSearch: {
      title: "Tool zoeken",
      description:
        "Houd een begrensde tooldirectory zichtbaar en stel de rest uit achter zoeken, zodat grote MCP- en plugincatalogi de prompt niet meer overladen.",
    },
    localModelLean: {
      title: "Slanke tools voor lokale modellen",
      description:
        "Laat zware standaardtools vallen die kleinere lokale modellen slecht aankunnen, en houd een kortere set over die ze betrouwbaar kunnen gebruiken.",
    },
    auditMessages: {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      subtitle: "Dreaming is een globale instelling; het is niet gebonden aan deze agent.",
      enableTitle: "Dromen inschakelen voor alle agents",
      enableDetail:
        "De nachtelijke droomronde wordt uitgevoerd op elke geconfigureerde agent-werkruimte en zet kortetermijnherinneringen om in langetermijngeheugen. Dit wordt direct toegepast.",
      enableConfirm: "Dromen inschakelen",
      disableTitle: "Dromen uitschakelen voor alle agents",
      disableDetail:
        "De nachtelijke droomronde stopt voor elke geconfigureerde agent, niet alleen deze. Al opgeslagen herinneringen blijven behouden; er wordt niets nieuws omgezet. Dit wordt direct toegepast.",
